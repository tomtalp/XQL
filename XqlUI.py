...
class MainWidget(QtGui.QMainWindow):
	...
	def openFile(self):
		...
		"""
		filename = QtGui.QFileDialog.getOpenFileName(self, 'Pick an Excel file', os.getenv('HOME'), "Excel Files (*.xls *.xlsx)")
	...
	def initUI(self):
		...
		self.selectedFileLabel = QtGui.QLabel('', self) # Show nothing for now, will be initialized after user picks a file
